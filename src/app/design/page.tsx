...
const SAMPLE_CLIENTS: ClientRecord[] = [
...
function AddClientModal({ onClose, onAdd }: { onClose: () => void; onAdd: (c: ClientRecord) => void }) {
...
export default function DesignPage() {
  ...
  const onSaveView = useCallback(async (view: Omit<ClientListView, "id">): Promise<string> => {
  ...
  const handleAddClient = useCallback((c: ClientRecord) => {
