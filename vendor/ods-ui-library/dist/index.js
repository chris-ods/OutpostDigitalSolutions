...
import { getApp as getApp2 } from "firebase/app";
import {
...
function getDB2() {
  return getFirestore2(getApp2());
}
function getStore() {
  return getStorage(getApp2());
}
async function seedPermissionsIfAbsent(collectionId) {
  const db = getDB2();
  const permRef = doc2(db, "permissions", collectionId);
...
function OdsPanel({
  ...
  const handleAdd = useCallback3(async (values, files) => {
    ...
    await addDoc2(collection2(db, collectionId), {
      ...base,
...
// ReceiptList.tsx
import { useState as useState5, useMemo as useMemo2, useRef as useRef4, useEffect as useEffect4 } from "react";
...
function ReceiptList({
  ...
  const [colOrder, setColOrder] = useState5(COLUMNS2.map((c) => c.key));
  const [colVisible, setColVisible] = useState5(DEFAULT_VISIBLE);
  const [showColPicker, setShowColPicker] = useState5(false);
  const [showExport, setShowExport] = useState5(false);
  const colPickerRef = useRef4(null);
  const exportRef = useRef4(null);
  ...
  const [showFilterBuilder, setShowFilterBuilder] = useState5(false);
  const uidRef = useRef4(0);
  function newId() {
    return String(++uidRef.current);
  }
  const [editingCell, setEditingCell] = useState5(null);
  const [dragCol, setDragCol] = useState5(null);
  const [dragOverCol, setDragOverCol] = useState5(null);
  const [page, setPage] = useState5(0);
  const tableScrollRef = useRef4(null);
  const hScrollTrackRef = useRef4(null);
  const [hThumb, setHThumb] = useState5({ show: false, left: 0, width: 0 });
  const thumbDragging = useRef4(false);
  const thumbStartX = useRef4(0);
  const thumbStartLeft = useRef4(0);
  useEffect4(() => {
    function handle(e) {
      if (colPickerRef.current && !colPickerRef.current.contains(e.target)) setShowColPicker(false);
      if (exportRef.current && !exportRef.current.contains(e.target)) setShowExport(false);
  ...
  const filteredReceipts = useMemo2(() => {
  ...
  const activeFilterCount = useMemo2(
  ...
  function renderCell(col, r) {
    ...
    if (isEditing) {
      ...
      return /* @__PURE__ */ jsx5("td", { className: "cl-td", children: /* @__PURE__ */ jsx5(
        CellInput2,
        {
          type,
    ...
    switch (col.key) {
      ...
      case "category":
        ...
        break;
      case "total":
        content = /* @__PURE__ */ jsx5("span", { style: { fontWeight: 600 }, children: fmtMoney(r.total) });
        break;
      case "subtotal":
    ...
    return /* @__PURE__ */ jsx5("td", { className: "cl-td", children: /* @__PURE__ */ jsxs5(
      "div",
      {
        className: "cl-cell-inner" + (canEdit ? " cl-cell-editable" : ""),
        onClick: () => canEdit && setEditingCell({ id: r.id, field: col.key }),
        children: [
          /* @__PURE__ */ jsx5("span", { className: "cl-cell-value", children: content }),
  ...
  function renderFilterBuilder() {
    if (!showFilterBuilder) return null;
    return /* @__PURE__ */ jsxs5("div", { className: "cl-filter-builder", children: [
      filterRows.length === 0 && /* @__PURE__ */ jsx5("div", { className: "cl-fb-empty", children: 'No filters \u2014 click "Add filter" to start.' }),
      filterRows.map((row) => {
        const col = COLUMNS2.find((c) => c.key === row.field);
        const ft = col?.filterType ?? "text";
        const ops = getOperators2(ft);
        const enumVals = ft === "enum" ? getEnumValues(receipts, row.field) : [];
        return /* @__PURE__ */ jsxs5("div", { className: "cl-fb-row", children: [
          /* @__PURE__ */ jsx5("span", { className: "cl-fb-where", children: "Where" }),
          /* @__PURE__ */ jsxs5(
            "select",
            {
              className: "cl-fb-select",
              ...
              children: [
                /* @__PURE__ */ jsx5("option", { value: "", children: "Select field\u2026" }),
                COLUMNS2.filter((c) => !c.noFilter).map((c) => /* @__PURE__ */ jsx5("option", { value: c.key, children: c.label }, c.key))
              ]
            }
          ),
          /* @__PURE__ */ jsx5(
          ...
          ft === "enum" ? /* @__PURE__ */ jsxs5(
          ...
          ) : row.operator === "between" ? /* @__PURE__ */ jsxs5(Fragment3, { children: [
            /* @__PURE__ */ jsx5(
              "input",
              {
                className: "cl-fb-input",
            ...
            /* @__PURE__ */ jsx5("span", { className: "cl-fb-and", children: "and" }),
            /* @__PURE__ */ jsx5(
              "input",
              {
                className: "cl-fb-input",
          ...
          /* @__PURE__ */ jsx5("button", { className: "cl-fb-remove", onClick: () => removeFilterRow(row.id), title: "Remove filter", children: /* @__PURE__ */ jsx5("svg", { width: "12", height: "12", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2.5, children: /* @__PURE__ */ jsx5("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M6 18L18 6M6 6l12 12" }) }) })
        ] }, row.id);
      }),
      /* @__PURE__ */ jsxs5("div", { className: "cl-fb-footer", children: [
        /* @__PURE__ */ jsxs5("button", { className: "cl-fb-add", onClick: addFilterRow, children: [
          /* @__PURE__ */ jsx5("svg", { width: "12", height: "12", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: /* @__PURE__ */ jsx5("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M12 4.5v15m7.5-7.5h-15" }) }),
          "Add filter"
        ] }),
        filterRows.length > 0 && /* @__PURE__ */ jsx5("button", { className: "cl-fb-clear", onClick: () => setFilterRows([]), children: "Clear all" })
      ] })
    ] });
  }
  if (loading) {
    return /* @__PURE__ */ jsx5("div", { className: "cl-root cl-loading", children: /* @__PURE__ */ jsx5("div", { className: "cl-loading-spinner" }) });
  }
  return /* @__PURE__ */ jsxs5("div", { className: "cl-root", children: [
    /* @__PURE__ */ jsx5("div", { className: "cl-header", children: /* @__PURE__ */ jsx5("div", { className: "cl-header-row", children: /* @__PURE__ */ jsxs5("div", { className: "cl-header-left", children: [
      /* @__PURE__ */ jsx5("div", { className: "cl-header-accent" }),
      /* @__PURE__ */ jsxs5("div", { children: [
        /* @__PURE__ */ jsx5("h1", { className: "cl-title", children: listTitle }),
        /* @__PURE__ */ jsxs5("p", { className: "cl-subtitle", children: [
          ...
          filteredReceipts.length > 0 && /* @__PURE__ */ jsxs5(Fragment3, { children: [
            " \xB7 ",
    ...
    /* @__PURE__ */ jsxs5("div", { className: "cl-toolbar-row", children: [
      /* @__PURE__ */ jsx5("div", { className: "cl-toolbar", children: /* @__PURE__ */ jsx5("div", { className: "cl-toolbar-seg", style: { fontSize: 12, color: "var(--cl-text-4)", padding: "0 8px" }, children: receipts.length === 0 ? "No receipts yet" : `${receipts.length} receipt${receipts.length !== 1 ? "s" : ""}` }) }),
      /* @__PURE__ */ jsxs5("div", { className: "cl-action-bar", children: [
        /* @__PURE__ */ jsxs5("div", { className: "cl-action-wrap", ref: colPickerRef, children: [
          /* @__PURE__ */ jsx5(
            "button",
            {
              className: "cl-action-btn" + (showColPicker ? " active" : ""),
              onClick: () => setShowColPicker((p) => !p),
              title: "Show / hide columns",
              children: /* @__PURE__ */ jsx5("svg", { width: "15", height: "15", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: /* @__PURE__ */ jsx5("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M9 4H5a1 1 0 00-1 1v14a1 1 0 001 1h4M9 4v16M9 4h6M9 20h6m0-16h4a1 1 0 011 1v14a1 1 0 01-1 1h-4M15 4v16" }) })
            }
          ),
          showColPicker && /* @__PURE__ */ jsxs5("div", { className: "cl-export-menu cl-col-picker-menu", children: [
            /* @__PURE__ */ jsxs5("div", { className: "cl-export-menu-header", style: { display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [
              /* @__PURE__ */ jsxs5("div", { children: [
                /* @__PURE__ */ jsx5("div", { className: "cl-export-menu-title", children: "Show / Hide Columns" }),
                /* @__PURE__ */ jsxs5("div", { className: "cl-export-menu-sub", children: [
                  colVisible === null ? pickableCols.length : colVisible.length,
                  " of ",
                  pickableCols.length,
                  " shown"
              ...
              /* @__PURE__ */ jsx5("button", { className: "cl-col-picker-reset", onClick: () => setColVisible(null), children: "Reset" })
            ] }),
            /* @__PURE__ */ jsx5("div", { className: "cl-col-picker-body", children: pickableCols.map((col) => {
              const checked = colVisible === null || colVisible.includes(col.key);
              return /* @__PURE__ */ jsxs5("label", { className: "cl-col-picker-row", children: [
                /* @__PURE__ */ jsx5("input", { type: "checkbox", checked, onChange: () => togglePickerCol(col.key) }),
                /* @__PURE__ */ jsx5("span", { children: col.label })
              ] }, col.key);
            }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxs5("div", { className: "cl-action-wrap", ref: exportRef, children: [
          /* @__PURE__ */ jsx5(
            "button",
            {
              className: "cl-action-btn" + (showExport ? " active" : ""),
              ...
              title: "Export to CSV",
              children: /* @__PURE__ */ jsx5("svg", { width: "15", height: "15", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: /* @__PURE__ */ jsx5("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" }) })
            }
          ),
          showExport && /* @__PURE__ */ jsxs5("div", { className: "cl-export-menu", children: [
            /* @__PURE__ */ jsxs5("div", { className: "cl-export-menu-header", children: [
              /* @__PURE__ */ jsx5("div", { className: "cl-export-menu-title", children: "Export to CSV" }),
              /* @__PURE__ */ jsx5("div", { className: "cl-export-menu-sub", children: "Exports all currently filtered records" })
            ] }),
            /* @__PURE__ */ jsx5("div", { className: "cl-export-menu-body", children: /* @__PURE__ */ jsx5("button", { className: "cl-export-dl-btn", onClick: () => {
    ...
    /* @__PURE__ */ jsxs5("div", { className: "cl-search-area", children: [
      /* @__PURE__ */ jsxs5("div", { className: "cl-search-row", children: [
        /* @__PURE__ */ jsxs5("div", { className: "cl-search-wrap", children: [
          /* @__PURE__ */ jsx5("svg", { className: "cl-search-icon", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: /* @__PURE__ */ jsx5("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" }) }),
          /* @__PURE__ */ jsx5(
            "input",
            {
              className: "cl-search-input",
          ...
          searchText && /* @__PURE__ */ jsx5("button", { className: "cl-search-clear", onClick: () => setSearchText(""), children: /* @__PURE__ */ jsx5("svg", { width: "14", height: "14", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: /* @__PURE__ */ jsx5("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M6 18L18 6M6 6l12 12" }) }) })
        ] }),
        /* @__PURE__ */ jsxs5(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx5("svg", { width: "14", height: "14", fill: "currentColor", viewBox: "0 0 20 20", children: /* @__PURE__ */ jsx5("path", { fillRule: "evenodd", d: "M3 3a1 1 0 011-1h12a1 1 0 011 1v3a1 1 0 01-.293.707L13 10.414V17a1 1 0 01-1.447.894l-4-2A1 1 0 017 15v-4.586L3.293 6.707A1 1 0 013 6V3z", clipRule: "evenodd" }) }),
              "Filter",
              activeFilterCount > 0 && /* @__PURE__ */ jsx5("span", { className: "cl-filter-toggle-count", children: activeFilterCount })
            ]
          }
        )
      ] }),
    ...
    showFilterBuilder && activeFilterCount > 0 && /* @__PURE__ */ jsxs5("div", { className: "cl-active-filters", children: [
      /* @__PURE__ */ jsx5("span", { className: "cl-active-filters-label", children: "Column filters:" }),
      Object.entries(filterSpecs).map(([col, spec]) => {
        ...
        if (spec.kind === "range" && (spec.min || spec.max)) chip = `${name}: ${spec.min ?? ""}\u2013${spec.max ?? ""}`;
        if (!chip) return null;
        return /* @__PURE__ */ jsxs5("span", { className: "cl-filter-chip", children: [
          chip,
          /* @__PURE__ */ jsx5("button", { className: "cl-filter-chip-remove", onClick: () => setFilterRows((prev) => prev.filter((r) => r.field !== col)), children: "\xD7" })
        ] }, col);
      }),
      /* @__PURE__ */ jsx5("button", { className: "cl-filter-clear-all", onClick: () => setFilterRows([]), children: "Clear all" })
    ] }),
    /* @__PURE__ */ jsxs5("div", { className: "cl-table-area", children: [
      filteredReceipts.length > 0 ? /* @__PURE__ */ jsxs5("div", { className: "cl-table-wrap", children: [
        /* @__PURE__ */ jsx5("div", { className: "cl-table-scroll", ref: tableScrollRef, onScroll: syncHThumb, children: /* @__PURE__ */ jsxs5("table", { className: "cl-table", children: [
          /* @__PURE__ */ jsx5("thead", { className: "cl-thead", children: /* @__PURE__ */ jsxs5("tr", { children: [
            visibleColDefs.map((col) => {
              const isSorted = sortField === col.key;
              const isDragging = dragCol === col.key;
              const isDragOver = dragOverCol === col.key && dragCol !== col.key;
              return /* @__PURE__ */ jsx5(
                "th",
                {
                  ...
                  children: /* @__PURE__ */ jsxs5("div", { className: "cl-th-inner", children: [
                    /* @__PURE__ */ jsx5(
                      "span",
                      {
                        className: "cl-drag-grip",
                        ...
                        title: "Drag to reorder",
                        children: /* @__PURE__ */ jsxs5("svg", { width: "12", height: "12", fill: "currentColor", viewBox: "0 0 16 16", children: [
                          /* @__PURE__ */ jsx5("circle", { cx: "5", cy: "4", r: "1.5" }),
                          /* @__PURE__ */ jsx5("circle", { cx: "11", cy: "4", r: "1.5" }),
                          /* @__PURE__ */ jsx5("circle", { cx: "5", cy: "8", r: "1.5" }),
                          /* @__PURE__ */ jsx5("circle", { cx: "11", cy: "8", r: "1.5" }),
                          /* @__PURE__ */ jsx5("circle", { cx: "5", cy: "12", r: "1.5" }),
                          /* @__PURE__ */ jsx5("circle", { cx: "11", cy: "12", r: "1.5" })
                        ] })
                      }
                    ),
                    col.sortable ? /* @__PURE__ */ jsxs5("button", { className: "cl-sort-btn" + (isSorted ? " sorted" : ""), onClick: () => handleSort(col.key), children: [
                      col.label,
                      /* @__PURE__ */ jsx5("span", { className: "cl-sort-arrow" + (isSorted ? "" : " unsorted"), children: isSorted ? sortDir === "asc" ? "\u2191" : "\u2193" : "\u2195" })
                    ] }) : /* @__PURE__ */ jsx5("span", { children: col.label })
                  ] })
                },
                col.key
            ...
            onDelete && /* @__PURE__ */ jsx5("th", { className: "cl-th-actions", children: "Delete" })
          ] }) }),
          /* @__PURE__ */ jsxs5("tbody", { children: [
            pageReceipts.map((r) => /* @__PURE__ */ jsxs5("tr", { className: "cl-tr", children: [
              visibleColDefs.map((col) => renderCell(col, r)),
              onDelete && /* @__PURE__ */ jsx5("td", { className: "cl-td-actions", children: /* @__PURE__ */ jsx5("button", { className: "cl-btn-unclaim", onClick: () => onDelete(r.id), title: "Delete", children: /* @__PURE__ */ jsx5("svg", { width: "12", height: "12", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: /* @__PURE__ */ jsx5("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M6 18L18 6M6 6l12 12" }) }) }) })
            ] }, r.id)),
            /* @__PURE__ */ jsxs5("tr", { className: "cl-tr", style: { borderTop: "1px solid var(--cl-border-2)", background: "var(--cl-surface)" }, children: [
              visibleColDefs.map((col) => /* @__PURE__ */ jsx5("td", { className: "cl-td", style: { color: "var(--cl-text-3)", fontWeight: 600 }, children: col.key === "merchant" ? /* @__PURE__ */ jsxs5("span", { style: { color: "var(--cl-text-4)", fontWeight: 400 }, children: [
              ...
              onDelete && /* @__PURE__ */ jsx5("td", { className: "cl-td-actions" })
            ] })
          ] })
        ] }) }),
        hThumb.show && /* @__PURE__ */ jsxs5("div", { className: "cl-hscroll-bar", children: [
          /* @__PURE__ */ jsx5("button", { className: "cl-scroll-left-btn", onClick: scrollToLeft, title: "Scroll to start", children: "\u2039" }),
          /* @__PURE__ */ jsx5("div", { className: "cl-hscroll-track", ref: hScrollTrackRef, onMouseDown: onTrackClick, children: /* @__PURE__ */ jsx5(
            "div",
            {
              className: "cl-hscroll-thumb",
              style: { left: hThumb.left, width: hThumb.width },
      ...
      ] }) : /* @__PURE__ */ jsxs5("div", { className: "cl-empty", children: [
        /* @__PURE__ */ jsx5("div", { className: "cl-empty-icon", children: /* @__PURE__ */ jsx5("svg", { width: "28", height: "28", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 1.5, style: { color: "var(--cl-text-4)" }, children: /* @__PURE__ */ jsx5("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M9 14.25l6-6m4.5-3.493V21.75l-3.75-1.5-3.75 1.5-3.75-1.5-3.75 1.5V4.757c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0111.186 0c1.1.128 1.907 1.077 1.907 2.185z" }) }) }),
        /* @__PURE__ */ jsx5("p", { className: "cl-empty-title", children: receipts.length === 0 ? "No receipts yet" : "No receipts match the filters" }),
        /* @__PURE__ */ jsx5("p", { className: "cl-empty-sub", children: receipts.length === 0 ? "Upload a receipt above to get started." : "Try adjusting your search or filters." })
      ] }),
      totalPages > 1 && /* @__PURE__ */ jsxs5("div", { className: "cl-pagination", children: [
        /* @__PURE__ */ jsxs5("button", { className: "cl-page-btn", onClick: () => setPage((p) => p - 1), disabled: page === 0, children: [
          /* @__PURE__ */ jsx5("svg", { width: "12", height: "12", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2.5, children: /* @__PURE__ */ jsx5("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M15 19l-7-7 7-7" }) }),
          "Prev"
        ] }),
        /* @__PURE__ */ jsxs5("span", { className: "cl-page-info", children: [
          "Page ",
          page + 1,
          " of ",
          totalPages
        ] }),
        /* @__PURE__ */ jsxs5("button", { className: "cl-page-btn", onClick: () => setPage((p) => p + 1), disabled: page >= totalPages - 1, children: [
          "Next",
          /* @__PURE__ */ jsx5("svg", { width: "12", height: "12", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2.5, children: /* @__PURE__ */ jsx5("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M9 5l7 7-7 7" }) })
        ] })
      ] })
    ] })
  ] });
