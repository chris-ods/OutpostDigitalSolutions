...
Contractor acknowledges and agrees that they are engaged as an independent contractor and not as an employee of the Company. Nothing in this Agreement shall be construed to create an employer-employee relationship. Contractor shall not be entitled to any employee benefits, including but not limited to unemployment insurance, workers' compensation, health insurance, or retirement benefits.

2. Commissions and 1099 Reporting
Contractor shall be compensated solely by commissions earned based on sales or production as determined by the Company. All compensation will be reported on IRS Form 1099-NEC. The Company shall not withhold federal, state, or local taxes, Social Security, or Medicare.

3. Taxes and Legal Compliance
Contractor is solely responsible for all taxes arising from payments received under this Agreement. Contractor agrees to indemnify and hold the Company harmless from any claims, liabilities, or penalties related to Contractor's tax obligations.

4. Tools, Equipment, and Expenses
Contractor shall supply and be responsible for all tools, equipment, and expenses necessary to perform the contracted services. Contractor shall not be reimbursed for any expenses unless agreed in writing by the Company.

5. Non-Solicitation and Confidentiality
During the term of this Agreement and for 12 months thereafter, Contractor shall not directly or indirectly solicit Company clients, agents, or leads for any competing business. Contractor shall maintain the confidentiality of all Company trade secrets, client information, and proprietary materials.

6. Termination
This Agreement may be terminated by either party at any time, with or without cause, upon written notice. Upon termination, Contractor shall immediately cease representing the Company and shall return all Company property and confidential materials.
...
By signing below, I acknowledge that I have read, understood, and agreed to the terms listed above.`,
  },
  {
    id: "dialer-addendum",
...
2. Daily Call Activity & Reporting: Complete a minimum of 300 outbound calls per day using approved scripts and leads. Submit daily call reports and weekly performance summaries to your manager.

3. Appointment & Lead Handling: Schedule at least 15 qualified appointments per week and promptly escalate hot leads to the assigned manager. Update the CRM or lead system same-day for all calls.

4. Mandatory Meetings: Attend the weekly contractor meeting/training every Monday at 8:50 AM to maintain active contract status.

5. Compliance & Professional Conduct: Follow all script and calling guidelines. Do not provide insurance advice or discuss coverage. Maintain confidentiality of all leads, scripts, and company data.

6. Contract Continuation: Failure to meet call, appointment, reporting, or sales contribution requirements may result in immediate contract termination. All company leads and data must be returned or deleted upon termination. This is a 1099 independent contractor role with no employee benefits, tax withholding, or unemployment eligibility.

By signing below, I acknowledge that I have read, understood, and agree to comply with the requirements outlined in this addendum.`,
  },
];
